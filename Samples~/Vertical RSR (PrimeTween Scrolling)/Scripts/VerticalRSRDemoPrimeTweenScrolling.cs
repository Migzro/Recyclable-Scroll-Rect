...
{
    public class VerticalRSRDemoPrimeTweenScrolling : MonoBehaviour, IDataSource
    {
        ...
        {
            _scrollRect.ScrollToTopRight(_timeToScroll, _isSpeed, _isInstant, PrimeTween.Ease.InOutElastic);
        }
